...
class BillingProductsAdapter: RecyclerView.Adapter<BillingProductsAdapter.BillProductsViewHolder>() {

    inner class BillProductsViewHolder(val binding: BillingProductsRvItemBinding) : ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BillingProductsAdapter.BillProductsViewHolder {
        return BillProductsViewHolder(
    ...
    override fun onBindViewHolder(holder: BillingProductsAdapter.BillProductsViewHolder, position: Int) {
